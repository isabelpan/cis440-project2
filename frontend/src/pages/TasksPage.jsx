            ...
            <div id='completedTasksListContainer' className='flex flex-col gap-5 line-through text-violet-300 hover'>
              ...
              <div>
                {completedTasks.map((task) => (
                  <button className='block mb-2 border-2 border-gray-200 rounded-md py-1 px-2 bg-violet-100 shadow-md hover:bg-white ease-out duration-300 hover:decoration-0 line-through' onClick={() => {setCurrentTask(task); undoComplete()}}><p>{task['task']}</p></button>
                ))} 
              </div> 
            </div>
